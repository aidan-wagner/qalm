"""
Plotting script for the 250-circuit greedy_k ablation.

Reads pickled results from greedy_k_guoq_benchmark_results/pkl/.
No experiments are run — this is plot-only.

Usage:
    python3 qalm_experiments/plot_greedy_k_guoq_benchmark.py
"""
...
_plot.RESULTS_DIR = "greedy_k_guoq_benchmark_results"
